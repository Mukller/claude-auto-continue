...
- **План запусков (циклы)** — задай несколько времён (05:00, 08:00, 17:00…), каждое отработает полный цикл. Опциональный ежедневный повтор или разовые запуски с автоудалением.
...
- **Прокручиваемый и сворачиваемый список чатов** — все найденные чаты видны в прокручиваемой области, заголовок «Список чатов» сворачивает/раскрывает блок кликом
